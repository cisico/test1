...
differences with Vi.  Actually Vim is not quite compatible with vi.  Nvi is
more compatible.
...
Send bug reports to:
	...
	We will provide a defect tracking system online next year.
...
- Security issue: vimrc file is updated to fix a potential security issue.
- Better Gnome support.  We vim can be embedded in most Gnome MDI applications.
